...
*/
    ...
    $response=array('success'=>false,'error'=>true,'stockproblem'=>false,'connectionprob'=>false);
    
    if(!isset($_SESSION['mail'])){
        $response['connectionprob']=true;
    }
    
    $nomItem=$_POST['nomItem'];
    
    $stockToAdd=$_POST['stockToAdd'];
    // Informations de connexion à la base de données
    $serveur = "localhost"; 
    $utilisateur = "root"; 
    $motDePasse = ""; 
