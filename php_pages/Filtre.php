					...
					<div class="filter">
						...
						<form method="get" action="./Filtre.php">
							<table>
								<tr>
									<td class="row">
										<label class="creation_text">Nom de l'objet :</label>
									</td>
									<td>
										<input class="input_box" type="text" name="searchname" id="searchname" />
									</td>
									<td>
									</td>
									<td class="row">
										<label class="creation_text">Type de l'objet
											:</label><!-- Penser à mettre des choix prédéfini-->
									</td>
								...
								<tr>
									...
									<td>
										<input class="input_box" type="text" name="prixmin" id="prixmin" />
									</td>
									<td class="row">
									...
									<td class="row">
										<input class="input_box" type="text" name="prixmax" id="prixmax" />
									</td>
								</tr>
								...
								<tr>
									...
									<td class="row">
										<input class="input_box" type="password" name="HPmin" id="HPmin" />
									</td>
									<td class="row">
										<div>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</div>
									</td>
									...
									<td class="row">
										<input class="input_box" type="text" name="HPmax" id="HPmax" />
									</td>
								...
								<tr>
									...
									<td class="row">
										<input class="input_box" type="text" name="APmin" id="APmin" />
									</td>
									<td>
									</td>
									<td class="row">
									...
									<td class="row">
										<input class="input_box" type="text" name="APmax" id="APmax" />
									</td>
								...
								<tr>
									...
									<td>
										<input class="input_box" type="text" name="ADmin" id="ADmin" />
									</td>
									<td>
									</td>
									<td class="row">
									...
									<td class="row">
										<input class="input_box" type="text" name="ADmax" id="ADmax" />
									</td>
